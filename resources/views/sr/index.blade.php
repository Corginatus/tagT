            ...
            <div class="container">
                <div class="row align-items-center justify-content-between mb-5 mb-lg-8">
                    <div class="col-xl-5 col-lg-6 mb-5 mb-lg-0 text-center text-lg-left">
                        <h2 class="font-weight-bold mb-4" data-aos="fade-up" data-aos-delay="50">Fokusiraj se na ono što
                            je važno.<br> Poverite nam <span class="text-primary">Instagram</span>, <span
                                class="text-primary">Facebook</span> i <span class="text-primary">Youtube
                                </span> to us <br></h2>
                        <p class="lead text-muted" data-aos="fade-up" data-aos-delay="100">Znamo da ste oduvek želeli da
                            angažujete najbolji marketinški tim, ali ste se plašili da uopšte pomislite koliko bi to
                            moglo da košta. Uz našu pomoć konačno ćete biti slobodni da uđete u svoj kreativni tok.</p>

                        <div
                            class="d-flex justify-content-center justify-content-lg-start flex-column flex-sm-row pt-4">
                            <a href="#contact-us" class="btn btn-primary mr-sm-2 mb-2 mb-sm-0 waves-effect"
                               data-aos="fade-up" data-aos-delay="150">Order </a>
                            <a href="https://calendly.com/eurovc" class="btn btn-white ml-sm-2 waves-effect"
                               data-aos="fade-up" data-aos-delay="200"><span>Schedule a call</span></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="container">
                <div class="row justify-content-center text-center mb-5 mb-lg-7">
                    <div class="col-xl-8 col-lg-8 col-sm-10">
                        <h2 class="font-weight-bold text-primary">Dozvoliti nam da gradimo i rastemo vaše društvene
                            zajednice je kao zapošljavanje 4 prvoklasna specijaliste</h2>
                        <p class="text-muted mb-0">Profesionalci koje mogu da zaposle samo velike kompanije radiće za
                            vas. Oni razvijaju komunikacione strategije za svetske brendove. Razumeju konopce. Dobijate
                            njihove ideje i stručnost za 1/4 budžeta koji biste potrošili na in-house marketer ili
                            PR. </p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-12" data-aos="fade-up">
                                    <div class="media mb-5">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="text-muted mb-0">Kreirajte plan sadržaja i strategiju komunikacije
                                                da biste ispravno podesili grupe.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-12" data-aos="fade-up" data-aos-delay="100">
                                    <div class="media mb-5">
                                        ...
                                        <div class="media-body">
                                            <h4 class="font-weight-bold mb-3 text-primary">NOVINAR</h4>
                                            <p class="text-muted mb-0">Da pišem kul i uzbudljiv sadržaj.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-12" data-aos="fade-up" data-aos-delay="200">
                                    <div class="media mb-5">
                                        ...
                                        <div class="media-body">
                                            <h4 class="font-weight-bold mb-3 text-primary">MODNI BLOGER</h4>
                                            <p class="text-muted mb-0">Da biste se angažovali sa publikom, dajte savete
                                                o modi i stilu.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-12" data-aos="fade-up" data-aos-delay="200">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="font-weight-bold mb-3 text-primary">MATERNJI GOVORNIK</h4>
                                            <p class="text-muted mb-0">Da komunicirate sa klijentima iz celog sveta
                                                (španski, nemački, italijanski itd.).
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <ul class="nav nav-flat nav-flat-primary" id="featureTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="featureOneTab" data-toggle="tab" href="#featureOne"
                                   role="tab">Upravljanje <br class="d-none d-sm-block">zajednicom </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="featureTwoTab" data-toggle="tab" href="#featureTwo" role="tab">Razvoj
                                    <br class="d-none d-sm-block">strategije <br
                                        class="d-none d-sm-block">sadržaja</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="featureThreeTab" data-toggle="tab" href="#featureThree"
                                   role="tab">Lojalnost i <br class="d-none d-sm-block">upravljanje <br
                                        class="d-none d-sm-block">reputacijom </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                ...
                                <div class="col-lg-6 mb-5 mb-lg-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0">Enhance project transparency with an easy to use
                                                API</p>
                                        </div>
                                    </div>
        ...
        <section class="py-5 bg-primary">
            <div class="container">
                <div class="row text-center text-white">
                    <div class="row row-cols-lg-3 row-cols-sm-2 row-cols-1 justify-content-between align-items-center">
                        <div class="w-sm-25">
                            <h2> Potpuna zamena marketinškog odeljenja</h2>
                        </div>
                        <div>
                            <p style="font-size: 17px;">
                                Spremni smo da preuzmemo sav rad marketinškog odeljenja. Za ovaj novac dobijate
                                marketera, specijalistu za oglašavanje i targetiranje, copywritera i dizajnera. Svaki od
                                ovih specijalista košta 2 puta više na tržištu, a mi smo angažovali najbolje od
                                najboljih.
                            </p>
                        </div>
        ...
        <section class="py-6">
            <div class="container">
                <div class="row justify-content-center align-items-center text-center mb-5">
                    <div class="col-xl-7 col-lg-10">
                        <h2 class="font-weight-bold text-primary">Kako radimo</h2>
                    </div>
                </div>
                <div class="row justify-content-between align-items-center mb-5">
                    ...
                    <div class="col-lg-5">
                        <div class="media flex-column flex-sm-row mb-5" data-aos="fade-up" data-aos-delay="50">
                            ...
                            <div class="media-body">
                                <h6 class="font-weight-bold text-primary">POJEDNOSTAVLJUJEŠ SVOJ ŽIVOT</h6>
                                <p class="text-muted font-size-sm mb-0">Nećemo samo doteći u red vaše društvene
                                    zajednice i mailing liste, već i rešiti probleme do kojih nikada niste stigli. Vaš
                                    život će postati lakši kada fokus ostane na pitanjima vezanim za razvoj vašeg modnog
                                    brenda, a ne na izboru slika i objava na društvenim mrežama.</p>
                            </div>
                        </div>
                        <div class="media flex-column flex-sm-row mb-5" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="media-body">
                                <h6 class="font-weight-bold text-primary">ŠTEDIMO VAŠE VREME</h6>
                                <p class="text-muted font-size-sm mb-0">
                                    Radimo potpuno autonomno i ne smetamo vam ni zbog čega. Mi vodimo teme naslova i
                                    plan sadržaja pored vas i finalizujemo ih sa vama 2 nedelje unapred. Imate pristup
                                    svim projektna dokumentacijama na internetu i vidite sve objavljene i planirane
                                    postove, a možete je proveriti u bilo kom trenutku.
                                </p>
                            </div>
                        </div>
                        <div class="media flex-column flex-sm-row mb-5" data-aos="fade-up" data-aos-delay="150">
                            ...
                            <div class="media-body">
                                <h6 class="font-weight-bold text-primary">MI UZIMAMO NAGOVEŠTAJ</h6>
                                <p class="text-muted font-size-sm mb-0">Lako razumemo šta želite, bez nepotrebnih
                                    tehničkih specifikacija i dugih sastanaka zumiranja. Projekat pokrećemo za 1 dan,
                                    zatim će vam trebati 5 minuta nedeljno da pregledate i odobrite sadržaj, kao i da
                                    vidite izveštaj sa statistikom o rastu prodaje i prihoda.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-5 order-2 order-lg-1">
                        <div class="media flex-column flex-sm-row mb-5" data-aos="fade-up" data-aos-delay="50">
                            ...
                            <div class="media-body">
                                <h6 class="font-weight-bold text-primary">POZNAJEMO VAŠU PUBLIKU</h6>
                                <p class="text-muted font-size-sm mb-0">Čak i ako se radi o 52-godišnjem neženji
                                    vegetarijancu, skuplja markice, posećuje samo pekaru iza ćoška 2 puta nedeljno.
                                    Saznaćemo za vas kakve lepinje voli, koji brendovi još nisu u kolekciji, u koje dane
                                    odlazi u pekaru i ponudićemo mu tačno ono što mu je potrebno iz vašeg asortimana.
                                    Da, <span
                                        class="text-primary font-weight-semibold">zvuči skoro kao fantazija, ali sa tačnošću možemo da predvidimo sa tačnošću od 94% da li će obaviti kupovinu!.</span>.
                                </p>
                            </div>
                        </div>
                        <div class="media flex-column flex-sm-row mb-5" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="media-body">
                                <h6 class="font-weight-bold text-primary">BEZ DIMA I OGLEDALA</h6>
                                <p class="text-muted font-size-sm mb-0">Dolazimo iz IT-ja i imamo jaku pozadinu podataka
                                    i nauke. Samo statistika i analitika, samo hardkor, zdrav razum i konkretni
                                    brojevi.</p>
                            </div>
                        </div>
                        <div class="media flex-column flex-sm-row mb-5" data-aos="fade-up" data-aos-delay="150">
                            ...
                            <div class="media-body">
                                <h6 class="font-weight-bold text-primary">PUN DALJINSKI UPRAVLJAČ</h6>
                                <p class="text-muted font-size-sm mb-0">To znači da smo vam dostupni sa bilo kog mesta.
                                    Možete otići na odmor ili putovati po svetu i biti uvereni da marketing radi kao
                                    sat. Radi samopouzdanja, svake nedelje šaljemo izveštaje sa rezultatima. </p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-6 bg-light-primary">
            <div class="container">
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-xl-7 col-lg-10">
                        <h2 class="font-weight-bold text-primary">Pretvaranje kreativnosti u biznis</h2>
                        <p class="text-muted mb-0">Postavljamo kanale prodaje i pošte, optimizujemo prodajni levak i
                            vraćamo napuštena kolica. Postavili smo retargeting, pronašli one koji su pregledali
                            proizvode na sajtu i dali pojedinačne ponude. <span
                                class="text-primary font-weight-semibold">I POČEĆEŠ DA ZARAĐUJEŠ VIŠE!</span>
                        </p>
                    </div>
                </div>
                            ...
                            <li class="nav-item w-100" role="presentation" data-aos="fade-up">
                                <a class="nav-link text-reset active" data-toggle="tab" href="#pane-1" role="tab">
                                    <div class="d-flex align-items-center align-items-lg-start">
                                        ...
                                        <div>
                                            <h6 class="line-height-16 text-primary">Identifikuje</h6>
                                            <p class="font-size-sm mb-0">Prikupljamo i analiziramo podatke o ponašanju,
                                                kako sa Vašeg web sajta, tako i iz različitih drugih izvora.</p>
                                        </div>
                                    </div>
                                </a>
                            </li>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-5 mb-5 mb-lg-0">
                        <h2 class="font-weight-bold mb-4 text-primary">Povoljne cene</h2>
                        <p class="mb-4">Verujemo da dobar SMM ne bi trebalo da košta pola miliona. Na osnovu ove
                            jednostavne ideje formiramo naše cene: izračunavamo naše troškove i nudimo vam kvalitetnu
                            uslugu.
                        </p>
                    </div>
                    <div class="col-lg-7">
                        <div class="row align-items-center no-gutters">
                            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <h3 class=" font-weight-semibold mb-0">5 - 30 <br/>thous. evri / mesec
                                            </h2>
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex align-items-center py-2">
                                                    <span style="font-size: 17px;">Stavili smo toliku cenu klijentima koji rade u vrhunskim agencijama.</span>
                                                </li>
                                                <li class="d-flex align-items-center py-2">
                                                        <span style="font-style: italic !important;"
                                                              class="text-primary">To podrazumeva troškove održavanja skupe kancelarije, pomoćnog osoblja, konferencija, putovanja, poslovnih ručkova itd.<br/>
                                                            Pa, razumete čija je to poslastica.
                                                        </span>
                                                </li>
                                            </ul>
                                    </div>
                            ...
                            <div class="col-md-4" data-aos="fade-up">
                                <div class="card bg-primary text-center text-white border-0">
                                    <div class="card-body">
                                        <h3 class="font-weight-bold mb-0">400 - 500 <br/>evra / mesec</h3>
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex align-items-center py-2">
                                                <span style="font-size: 17px;">Izračunati trošak na osnovu naših realih troškova. Mi to radimo na ovaj način, jer klijenti ostaju sa nama duže vreme.</span>
                                            </li>
                                            <li class="d-flex align-items-center py-2">
                                                <span style="font-style: italic !important;">To podrazumeva komunikaciju uživo i popunjavanje vaših društvenih medijskih zajednica zanimljivim i kvalitetnim sadržajem.</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <h3 class="font-weight-bold mb-0">100-200 <br/>evra</h3>
                                        <ul class="list-unstyled mb-0">
                                            <li class="d-flex align-items-center py-2">
                                                    <span style="font-size: 17px;">Takvu cenu postavljaju zanatlije za udujavanje botova u vašu zajednicu.
                                                    </span>
                                            </li>
                                            <li class="d-flex align-items-center py-2" style="font-style: italic;">
                                                <span class="text-primary">Postoji samo jedan problem - bot neće kupiti ništa.</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5 order-1 order-lg-1 pt-6 pb-4">
                        ...
                        <ul class="steps vertical list-unstyled mb-0">
                            <li data-aos="fade-up">
                                <span>1</span>
                                MI NE PREUZIMAMO ONO ŠTO NE MOŽEMO DA URADIMO SAVRŠENO
                                <p>Ponekad odustanemo od projekta. Zato što ne možemo da garantujemo kvalitetne
                                    performanse. I to je fer prema tebi.</p>
                            </li>
                            <li data-aos="fade-up" data-aos-delay="50">
                                <span>2</span>
                                RADIMO PO JASNOM PLANU
                                <p>Razvijamo komunikacionu strategiju i plan sadržaja.</p>
                            </li>
                            <li data-aos="fade-up" data-aos-delay="100">
                                <span>3</span>
                                SMANJIMO BIROKRATIJU NA MINIMUM
                                <p>Štitimo kupce: ispunjavamo rokove, ne tražimo nepotrebne tehničke specifikacije,
                                    trudimo se da formalnosti i vreme provedeno na delu klijenta svedemo na minimum.</p>
                            </li>
                            <li data-aos="fade-up" data-aos-delay="150">
                                <span>4</span>
                                HAJDE, POŽURI I NARUČI
                                <p>Samo nam pošaljite kratak opis vašeg slučaja i mi ćemo se potruditi da ponudimo
                                    najbolje rešenje.
                                </p>
                            </li>
                        </ul>
